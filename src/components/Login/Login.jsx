...
function Login() {
    ...
    function onSubmit(e) {
        ...
        if (validationResult.error) {
            ...
            axios.post("https://citizenconnect-plhr.onrender.com/api/admin-login/", adminData)
                .then(res => {
                    ...
                    setload(false);
                    setServerErr("wrong username or password")
            ...
            <div className="bg-white p-7 rounded-lg shadow-xl">
                ...
                <form onSubmit={onSubmit} className="mt-5 login">
                    <div className="relative border rounded-lg overflow-hidden bg-zinc-300">
                        <label className="absolute top-1/2 -translate-y-1/2 left-4 transition-all text-gray-600">user name</label>
                        <input
                            onFocus={onFocus}
                            onBlur={onBlur}
                            onChange={onChange}
